...
/**
 * This class is a m_lexer generated by 
...
public class Lexer {
  ...
  /** initial size of the m_sym buffer */
  ...
  /** 
   * zzAtBOL == true     the m_lexer is currently at the beginning of a line
   */
  private boolean zzAtBOL = true;

  /** zzAtEOF == true   the m_lexer is at the EOF */
...
int get_column(){	return yycolumn;}
  ...
  /**
   * Resets the m_lexer to read from a new input stream.
   ...
   *
   * In a wellformed m_lexer (no or only correct usage of 
   * yypushback(int) and a match-all fallback rule) this method 
   * will only be called with things that "Can't Possibly Happen".
   * If this method is called, something is seriously wrong
   * (e.g. a JFlex bug producing a faulty m_lexer etc.).
   *
   * Usual syntax/m_lexer level error handling should be done
   ...
   * @exception   java.io.IOException  if any I/O-Error occurs
   */
  public Symbol nextNode() throws java.io.IOException, LexicalException {
    int zzInput;
    int zzAction;
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        case 52: 
          { return new Symbol(Node.PROCEDURE, yytext());
          }
        case 53: break;
        case 17: 
          { return new Symbol(Node.SEMI, yytext());
          }
        case 54: break;
        case 31: 
        ...
        case 7: 
          { if (yylength() > 12)
			...
			if (yytext().charAt(0) == '0' && yytext().length()>1)
				return new Symbol(Node.NUMBER, yytext());
			return new Symbol(Node.NUMBER, yytext());
          }
        case 56: break;
        case 29: 
          { return new Symbol(Node.LE, yytext());
          }
        case 57: break;
        case 41: 
          { return new Symbol(Node.ELSIF, yytext());
          }
        case 58: break;
        case 48: 
          { return new Symbol(Node.RECORD, yytext());
          }
        case 59: break;
        case 10: 
          { return new Symbol(Node.COLON, yytext());
          }
        case 60: break;
        case 16: 
          { return new Symbol(Node.NOT, yytext());
          }
        case 61: break;
        case 18: 
          { return new Symbol(Node.COMMA, yytext());
          }
        case 62: break;
        case 8: 
          { return new Symbol(Node.PLUS, yytext());
          }
        case 63: break;
        case 20: 
          { return new Symbol(Node.LBRACKET, yytext());
          }
        case 64: break;
        case 6: 
          { if (yylength() > 24)
				throw new IllegalIdentifierLengthException(yytext());
			return new Symbol(Node.IDENTIFIER, yytext());
          }
        case 65: break;
        case 24: 
          { return new Symbol(Node.DO, yytext());
          }
        case 66: break;
        case 36: 
          { /*Do nothing*/
        ...
        case 67: break;
        case 4: 
          { return new Symbol(Node.RPAREN, yytext());
          }
        case 68: break;
        case 32: 
          { return new Symbol(Node.DIVIDE, yytext());
          }
        case 69: break;
        case 15: 
          { return new Symbol(Node.AND, yytext());
          }
        case 70: break;
        case 44: 
          { return new Symbol(Node.BEGIN, yytext());
          }
        case 71: break;
        case 42: 
          { return new Symbol(Node.WRITE, yytext());
          }
        case 72: break;
        case 50: 
          { return new Symbol(Node.WRITELN, yytext());
          }
        case 73: break;
        case 5: 
          { /*skip it*/
        ...
        case 74: break;
        case 34: 
          { return new Symbol(Node.MOD, yytext());
          }
        case 75: break;
        case 26: 
          { return new Symbol(Node.OR, yytext());
          }
        case 76: break;
        case 40: 
          { return new Symbol(Node.ELSE, yytext());
          }
        case 77: break;
        case 11: 
          { return new Symbol(Node.EQ, yytext());
          }
        case 78: break;
        case 9: 
          { return new Symbol(Node.MINUS, yytext());
          }
        case 79: break;
        case 30: 
          { return new Symbol(Node.GE, yytext());
          }
        case 80: break;
        case 28: 
          { return new Symbol(Node.ASSIGN, yytext());
          }
        case 81: break;
        case 38: 
          { return new Symbol(Node.THEN, yytext());
          }
        case 82: break;
        case 33: 
          { return new Symbol(Node.VAR, yytext());
          }
        case 83: break;
        case 23: 
        ...
        case 84: break;
        case 45: 
          { return new Symbol(Node.CONST, yytext());
          }
        case 85: break;
        case 39: 
          { return new Symbol(Node.TYPE, yytext());
          }
        case 86: break;
        case 21: 
          { return new Symbol(Node.RBRACKET, yytext());
          }
        case 87: break;
        case 25: 
          { return new Symbol(Node.IF, yytext());
          }
        case 88: break;
        case 1: 
        ...
        case 89: break;
        case 13: 
          { return new Symbol(Node.LT, yytext());
          }
        case 90: break;
        case 3: 
          { return new Symbol(Node.TIMES, yytext());
          }
        case 91: break;
        case 46: 
          { return new Symbol(Node.ARRAY, yytext());
          }
        case 92: break;
        case 2: 
          { return new Symbol(Node.LPAREN, yytext());
          }
        case 93: break;
        case 49: 
          { return new Symbol(Node.INTEGER, yytext());
          }
        case 94: break;
        case 37: 
          { return new Symbol(Node.READ, yytext());
          }
        case 95: break;
        case 35: 
          { return new Symbol(Node.END, yytext());
          }
        case 96: break;
        case 12: 
          { return new Symbol(Node.NEQ, yytext());
          }
        case 97: break;
        case 47: 
          { return new Symbol(Node.MODULE, yytext());
          }
        case 98: break;
        case 19: 
          { return new Symbol(Node.PERIOD, yytext());
          }
        case 99: break;
        case 43: 
          { return new Symbol(Node.WHILE, yytext());
          }
        case 100: break;
        case 22: 
        ...
        case 101: break;
        case 51: 
          { return new Symbol(Node.BOOLEAN, yytext());
          }
        case 102: break;
        case 14: 
          { return new Symbol(Node.GT, yytext());
          }
        case 103: break;
        case 27: 
          { return new Symbol(Node.OF, yytext());
          }
        case 104: break;
        default: 
          if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
            zzAtEOF = true;
              { 	return new Symbol(Node.EOF);
 }
          } 
          else {
